                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        TextButton(
                                          child: Text("Camera"),
                                          onPressed: () {
                                            _getImage(ImageSource.camera, _interiorImageFiles!);
                                        ...
                                        TextButton(
                                          child: Text("Gallery"),
                                          onPressed: () {
                                            _getImage(ImageSource.gallery, _interiorImageFiles!);
                                            Navigator.of(context).pop();
                                          },
                                        ),
                                      ],
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        TextButton(
                                          child: Text("Camera"),
                                          onPressed: () {
                                            _getImage(ImageSource.camera, _exteriorImageFiles!);
                                            Navigator.of(context).pop();
                                          },
                                        ),
                                        TextButton(
                                          child: Text("Gallery"),
                                          onPressed: () {
                                            _getImage(ImageSource.gallery, _exteriorImageFiles!);
                                            Navigator.of(context).pop();
                                          },
                                        ),
                                      ],
